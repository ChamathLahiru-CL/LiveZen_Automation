...
Call log:
  ...
  - waiting for locator('#email')
    9 × locator resolved to <input value="" id="email" type="text" name="email" placeholder="Enter username or email" class="w-full border rounded-md px-3 py-2 text-[13.5px] placeholder:text-[13.5px] ↵                  bg-white dark:bg-slate-700 text-black dark:text-white↵                  disabled:bg-slate-100 dark:disabled:bg-slate-600 disabled:border-slate-300 dark:disabled:border-slate-500 disabled:text-slate-500 dark:disabled:text-slate-400↵                  placeholder:text-slate-400 dark:placeholder:text-slate-500↵      …/>
      - unexpected value ""
