...
export default class Topbar {
    ...
    readonly languageOptionFrench: Locator;
    readonly languageOptionSpanish: Locator;
    readonly languageOptionGerman: Locator;
    readonly languageOptionSinhalese: Locator;
    readonly languageOptionHindi: Locator;
    readonly languageOptionTamil: Locator;
    readonly notificationButton: Locator;
    readonly seeAllNotificationsButton: Locator;
    ...
    readonly closeSettingButton: Locator;
